...
OpenCL kernels.  We use the ROSE compiler infrastructure \cite{rose-web} to develop
these transformations.  ROSE uses the Open Fortran Parser \cite{ofp-web} to parse
...
\cite{pooma-cite}.  Similar experiences have occurred in the past, notably during the
