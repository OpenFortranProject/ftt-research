...
\KEYWORD{Fortran; OpenCL; Accelerator programming; GPU programming; code generation.}
...
%% this was only required for review purposes - remove in final
%\newpage
%
%\input{note-to-reviewers}
