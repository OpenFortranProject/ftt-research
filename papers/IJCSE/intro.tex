...
machine architecture to the programmer~\citep{wolfe08gpgpu}.  The programmer is
...
infrastructure~\citep{rose-web} to develop these
transformations.  ROSE uses the Open Fortran
Parser~\citep{ofp:sf} to parse Fortran 2008
