...
in order to avoid mixing values computed in the current loop with values from a 
...
elemental functions now need to be explicitly labelled as pure to ensure that they
