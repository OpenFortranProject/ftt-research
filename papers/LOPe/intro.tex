...
However, in large part these languages are largely syntatic sugar for message passing and do not
...
%%and yet are welcome to considering the simplifications of UPC and Coarray Fortran.
