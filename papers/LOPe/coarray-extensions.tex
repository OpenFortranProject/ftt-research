...
This allocation statement specifies that (given the 1 element halo size provided earlier for
...
This section describes the hierarchical memory layout and how memory consistency between
