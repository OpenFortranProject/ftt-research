...
implicit in the \texttt{CONCURRENT} attribute\todo{clarify what sync
  errors are prevented.  restricted concurrency model === less room
  for errors.}.  A thread running a concurrent procedure is provided
